            ...
            try:
                ...
                try:
                    self.bot.restrict_chat_member(message.chat.id, message.new_chat_member.id,
                                                  until_date=time() + self.settings.data['bantime'],
                ...
                if search(self.settings.data['chkrgx'], message.new_chat_member.first_name + message.new_chat_member.last_name, I | M | U):
