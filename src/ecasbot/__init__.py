...
class ASBot:
    ...
    def __handle_unrestrict(self, message) -> None:
        ...
        try:
            if message.reply_to_message:
                unbanperm = telebot.types.ChatPermissions(can_send_messages=True, can_send_media_messages=True,
                ...
                self.__bot.restrict_chat_member(message.chat.id, message.reply_to_message.from_user.id,
                                                permissions=unbanperm, use_independent_chat_permissions=True)
    ...
    def runbot(self) -> None:
        ...
        while True:
            try:
                ...
                self.__logger.error(self.__get_lm('as_crashed').format(ex))
